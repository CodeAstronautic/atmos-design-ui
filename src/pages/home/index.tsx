  ...
  return (
    <div>
      <div className="bannerContent">
        ...
        <div className="pb-[108px] ml-[16.5rem] max-[1800px]:ml-[13rem] max-[1700px]:ml-[10rem] service-tab-slide max-[1600px]:ml-[7rem]  max-[1440px]:ml-[10rem]  max-[1200px]:ml-[7.5rem] max-[1024px]:ml-[2rem] max-[771px]:ml-4 max-md:hidden">
          <ServiceSection />
        </div>
      </div>
