          ...
          {users?.map((person, index) => {
            ...
            return (
              <div key={index} className={` ${activeSlide === index ? 'slick-current' : ''}`}>
                <div
                  className={`bg-white rounded-2xl shadow-md p-9 max-md:px-[16px] text-center ${isLeftCard ? '!bg-[#EDFCFF] max-[1500px]:mx-[23px] max-[1240px]:mx-[115px] max-[1200px]:mx-[105px] max-[768px]:mx-[136px] max-[479px]:mx-[74px] max-[425px]:mx-[60px]' : ''} ${isRightCard ? '!bg-[#EDFCFF] max-[1240px]:mx-[-100px] max-[1200px]:mx-[-80px] max-[768px]:mx-[-100px] max-[479px]:mx-[-47px] max-[425px]:mx-[-22px] max-[375px]:mx-[-20px] max-[320px]:mx-[-54px]' : ''} ${activeSlide === index ? 'w-[291px] max-w-[291px] max-[425px]:w-[234px] max-[320px]:w-[192px]' : 'w-[291px] max-w-[291px] max-[425px]:w-[218px] max-[375px]:w-[204px] max-[360px]:w-[197px]'}`}>
