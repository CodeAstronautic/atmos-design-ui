...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title }) => {
  return (
    <div className="flex overflow-hidden gap-6 items-center p-4 rounded-xl bg-white bg-opacity-20 min-w-[240px] w-[320px] min-[1700px]:w-[300px] max-[1600px]:w-[300px] max-[1200px]:w-[345px] max-[1024px]:w-[320px] max-[771px]:w-[360px] slide-service-box ">
