...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="flex flex-col justify-center pt-[95px] pb-[80px] rounded-none px-20 max-xl:px-10 max-[1200px]:px-8 max-[768px]:px-4 w-full container mx-auto max-md:pt-[64px] max-md:pb-[60px]">
