    ...
    <>
      <div className="flex flex-col w-[26%] max-md:ml-0 max-md:w-full">
        <div className="flex flex-col items-start mt-1 text-sm font-black text-gray-600 max-md:mt-8">
          ...
          <div className="self-stretch mt-1.5 text-[13px] leading-[19.5px] text-[#5E626F] font-black break-words">
            {cinNumber}
          </div>
        </div>
      </div>
      <div className="flex flex-col ml-5 w-[74%] max-md:ml-0 max-md:w-full">
        <div className="flex grow gap-0.5 max-md:mt-7">
          <div className="flex flex-col grow shrink-0 items-start self-start mt-1 text-sm font-black text-gray-600 basis-0 w-fit max-md:max-w-full">
            ...
            <div className="self-stretch mt-1.5 break-words text-[13px] leading-[19.5px] text-[#5E626F] font-black max-md:max-w-full">
              {addressIndia}
            </div>
          </div>
        </div>
