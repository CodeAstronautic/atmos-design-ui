...
const FooterColumn: React.FC<FooterColumnProps> = ({ companyName, ceo, ceoNameIndia, companyNameIndia }) => {
  return (
    <div className="flex flex-col w-[22%] max-xl:w-[33%] max-md:ml-0 max-lg:w-full">
      <div className="flex flex-col items-start w-full font-black max-md:mt-0">
        <div className="flex gap-5 max-lg:gap-9 self-stretch max-md:justify-start">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-[5px] text-[13px] leading-[19.5px] text-[#5E626F] font-black break-words w-max">
              {ceoNameIndia}
            </div>
          </div>
        </div>
